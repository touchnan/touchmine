/*
 * cn.touchnan.busi.serv.impl.UserService.java
 * May 25, 2012 
 */
...
public class UserService extends BaseService<UserDto, User, Long> implements IUserService {
     ...
     * 
     * @see
     * cn.touchnan.busi.serv.IUserService#findCacheUser(cn.touchnan.dto.Ar)
     */
    @Override
     ...
     * (non-Javadoc)
     * 
     * @see cn.touchnan.busi.serv.IUserService#resetPasswd(java.lang.Long,
     ...
     * (non-Javadoc)
     * 
     * @see cn.touchnan.busi.serv.IUserService#resetSelfPasswd(cn.chuzheng.sgmr
     ...
     * (non-Javadoc)
     * 
     * @see cn.touchnan.busi.serv.IUserService#resetPasswd(cn.touchnan.
     ...
     * (non-Javadoc)
     * 
     * @see cn.touchnan.busi.serv.IUserService#auth(java.lang.String,
     * java.lang.String)
     */
    @Override
